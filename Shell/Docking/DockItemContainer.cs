...
namespace Cage.Shell.Docking
{
	class DockItemContainer: VBox
	{
		...
		{
			try {
				pixClose = Gdk.Pixbuf.LoadFromResource("Cage.Shell.Docking.stock-close-12.png");
				pixAutoHide = Gdk.Pixbuf.LoadFromResource ("Cage.Shell.Docking.stock-auto-hide.png");
				pixDock = Gdk.Pixbuf.LoadFromResource ("Cage.Shell.Docking.stock-dock.png");
			} catch (Exception) {
			}
		}
